...
export class QuestionFactory {
  ...
  toSelectQuestion(schemaQuestion: any): SelectQuestion {
    ...
    this.mapCommonProperties(schemaQuestion, question);
  ...
  getGroupMembers(schema: any): any {
    ...
    return groupMembers;
  >>>>>>> OFO-50: Add support for historical expressions
...
<<<<<<< HEAD
  ...
  =======
    ...
    mapCommonProperties(schemaQuestion: any, question: QuestionBase) {
